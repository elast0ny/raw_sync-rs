...
| Feature| Description | Linux | Windows|  Mac| FreeBSD |
|--------|-------------|:-----:|:------:|:----:| :-----: |
|EventType::Auto/Manual| Generic event : [pthread_cond](https://linux.die.net/man/3/pthread_cond_init) on Unix and [Event Objects](https://msdn.microsoft.com/en-us/library/windows/desktop/ms682655.aspx) on windows. |✔|✔|X|✔|
